...
CREATE TABLE attendance (
    ...
    early_in_minutes SMALLINT UNSIGNED NULL,
    late_in_minutes SMALLINT UNSIGNED NULL,
    early_out_minutes SMALLINT UNSIGNED NULL,
    late_out_minutes SMALLINT UNSIGNED NULL,
