...
--
-- Logins:
--   admin@highwaygrill.com     / hg2015       (System Admin — settings/compliance)
--   security@highwaygrill.com  / dsadsadsa    (Super Admin — security portal)
...
-- dsadsadsa:    $2b$10$/lri.h937tU4c493QNkESOI1OhavjQyxtCN1./TkHzXFJCagLMMZ2

INSERT INTO roles (role_id, role_slug, role_name, description, role_type, is_system, display_order) VALUES
(1, 'admin',       'System Admin', 'Platform settings, compliance, and staff access', 'system', true, 1),
(4, 'super_admin', 'Super Admin',  'Security monitoring — logs, threats, and employee locations', 'system', true, 0),
...
(28, 'security.view',               'View security dashboard',    'security',    'Login logs, threats, and employee map'),
(29, 'security.manage',             'Manage security settings',   'security',    'Resolve threats and security configuration')
ON CONFLICT (permission_key) DO NOTHING;

-- System Admin: platform tools only (not security monitoring)
INSERT INTO role_permissions (role_id, permission_id)
SELECT 1, permission_id FROM permissions WHERE permission_key NOT LIKE 'security.%' ON CONFLICT DO NOTHING;

-- Super Admin: security permissions only
INSERT INTO role_permissions (role_id, permission_id)
SELECT 4, permission_id FROM permissions WHERE permission_key IN ('security.view', 'security.manage') ON CONFLICT DO NOTHING;

INSERT INTO role_permissions (role_id, permission_id)
SELECT 2, permission_id FROM permissions
WHERE permission_key <> 'users.manage' AND permission_key NOT LIKE 'security.%'
...
(3, 'security@highwaygrill.com', '$2b$10$/lri.h937tU4c493QNkESOI1OhavjQyxtCN1./TkHzXFJCagLMMZ2', 4, NULL, true, 'active', NOW()),
